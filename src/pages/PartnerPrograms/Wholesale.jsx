  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <header className="p-4">
        ...
        Gain <span className="text-red-600">access to competitive wholesale prices </span>
        from renowned network providers.
        </p>
        <h1 className="text-3xl md:text-5xl font-bold text-center text-gray-500 px-4">
        Elevate Your Offering: Unleash Telecom Excellence with our Wholesale Partnership Model
        </h1>
      </header>
      ...
      <main className="p-4">
        <div className="flex flex-col md:flex-row gap-4 my-8 mx-4 md:mx-16">
          ...
          <div className="md:w-1/2">
            <div className="border-l-4 border-blue-900 pl-4">
              ...
              We provide professional <br/>support to make selling <br/> easy for you.
              </h1>
            </div>
          ...
          <div className="md:w-1/2">
            ...
            Joining our Wholesale Partnership Program is straightforward. We have designed
            our wholesale partner program to eliminate convoluted agreements and complex
            requirements typically associated with partnering with major suppliers.<br/>
            <div className="mt-10">By joining our wholesale partner programme, you can 
            leverage our strong relationships with all the major network providers 
            in the UK. This means you gain access to their expansive network coverage,
            dedicated support, and most importantly, wholesale prices.<br/></div> 
            </p>
          </div>
        </div>

        {/* Feature grid */}
        <p className="text-gray-500 -mb-6 ml-10">Why joining our Wholesale partner programme:</p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-lg md:text-xl px-4 md:px-16 pb-10 md:py-20">
          {[
            { icon: <BarChart2 />, text: "Incentive & Growth Programs" },
            { icon: <ServerCog />,text: "Sole Branded Marketing Collateral "},
            { icon: <Users />, text: "Provisioning & Fault Management" },
          ].map((feature, index) => (
            <div
              key={index}
        ...
        <p className="text-gray-500 mb-10 ml-10">We are dedicated to supporting your business through our extensive experience, 
        strategic partnerships, and innovative solutions without the complexities. 
        We simplify the process so you can focus on growing your business.
        <div className="mt-8">
        Together, we can forge a successful partnership that propels your business 
    ...
    <h1 className="text-3xl md:text-5xl font-bold text-center mb-16 text-gray-500 px-4">
    Join our White Label Partner Program today and unlock a world of opportunities for your business.
        ...
        <div className="flex flex-wrap justify-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl space-x-4 sm:space-x-6 md:space-x-8 lg:space-x-10 mb-8 sm:mb-12 md:mb-16">
  {["Referral", "Dealer", "White Label", "Wholesale"].map((item, index) => (
    <div
      key={index}
      className={`flex items-center ${
        item === "Wholesale" ? "text-red-500" : "text-gray-400"
      }`}
    >
      <svg
