  ...
  return (
    <>
        ...
        <div className="relative flex items-center justify-center h-full text-center px-4 md:px-8 lg:px-16">
          <div className="max-w-4xl">
            <h1 className="text-2xl md:text-2xl lg:text-2xl font-bold text-white">
              Leased Line Broadband: Unlock super fast speeds Starting from £160
              for 100/100
            </h1>
            <p className="text-white text-lg md:text-xl mb-2">
              Uncapped, uncontended, and symmetrical leased line broadband fibre
              for your business, with wide range of speed options available.
            </p>
      ...
      <header className="p-4">
        ...
        Leased line broadband is the perfect solution for businesses
            demanding high-quality, high-speed, and reliable internet
            connectivity.
        </h1>
      </header>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8 mt-8 mx-4 md:mx-16">
        ...
        <div className="md:w-1/2">
          <div className="border-l-4 border-red-600 pl-4">
            ...
            Leased line broadband is the most reliable internet connection
            for businesses that need the very best broadband option.
            </h1>
          </div>
        </div>
        ...
        <p className="text-gray-500 mb-6 text-xl">
                Our Leased Line Broadband Connection services are designed to
                provide optimal connectivity with speeds of up to 1Gbps,
                guaranteeing a seamless internet experience. Fidelity Group’s
                ethernet services are the perfect solution for accessing
                cloud-based applications, voice and collaboration tools, or fast
                internet access. With IP telephony, video and conferencing
                services, and instant messaging capabilities, our leased line
                broadband solutions for business, make us the perfect end-to-end
                supplier for your connectivity and communication requirements.
                We understand businesses have unique requirements, and our fibre
                leased line broadband solutions are customisable to fit specific
                needs and budgets.
              </p>
