    ...
    <>
        ...
        <div className="relative flex items-center justify-center h-full text-center px-4 md:px-8 lg:px-16">
          <div className="max-w-4xl">
            ...
            <p className="text-white text-lg md:text-xl mb-2">
              FTTP helps improve productivity with superior bandwidth, and is
      ...
      <header className="p-4">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8">
          Experience superior business fibre broadband with our FTTP internet
          connection, providing a fast data connectivity internet speed.
        </h1>
      </header>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8 mt-8 mx-4 md:mx-16">
          ...
          <div className="border-l-4 border-red-600 pl-4">
            <h1 className="text-xl md:text-2xl font-semibold mb-2">
              <span className="text-red-600">
                FTTP: Highly-reliable, secure and
              </span>{" "}
              fast data connectivity. Internet speeds up to 1Gbps.
            </h1>
          </div>
        </div>
        ...
        <div className="md:w-1/2">
          <p className="text-gray-500 mb-6 text-xl">
            Our market leading FTTP business broadband solutions provide an
            unparalleled level of reliability. Elevate your business’
            connectivity with Fidelity Group, choosing from the fastest and most
            reliable FTTP (Fibre to the Premises) broadband deals from the best
            internet providers in your area. Get in touch to discover more and
            experience the unparalleled advantages of FTTP internet.
          </p>
